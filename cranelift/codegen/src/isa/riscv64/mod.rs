...
impl Riscv64Backend {
    ...
    fn compile_vcode(
        ...
        let abi = Box::new(abi::Riscv64ABICallee::new(func, flags)?);
        compile::compile::<Riscv64Backend>(func, self, abi, emit_info)
    }
}

impl MachBackend for Riscv64Backend {
    fn compile_function(
        &self,
        func: &Function,
        want_disasm: bool,
    ...
    fn emit_unwind_info(
        ...
        Ok(match kind {
            ...
            UnwindInfoKind::Windows => {
                // TODO: support Windows unwind info on Riscv64
                None
            }
            _ => None,
        })
